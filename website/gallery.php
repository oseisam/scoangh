...
<nav class="navbar navbar-default">
  <div class="container-fluid"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="www.scoan.org">SCOAN</a> </div>
  ...
  <div class="jumbotron">
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
			<li>
    <div class="banner-bg ChristlivesBG-banner-img">
        <div class="container-fluid">
...
<li>
    <div class="banner-bg technology-banner-img">
        <div class="container-fluid">
            <div class="banner-info">
...
<li>
    <div class="banner-bg home-banner-img">
        <div class="container-fluid">
            <div class="banner-info">
...
<section>
  ...
  <div class="container ">
    <div class="row">
      <div class="col-lg-4 col-sm-12 text-center"> <img class="img-thumbnail" alt="400x300" style="width: 300px; height: 200px;" src="images/66-1-1200x732.jpg" data-holder-rendered="true">
        <h3>Prophet TB Joshua</h3>
